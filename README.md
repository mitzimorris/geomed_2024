...
* The quarto files provide both Python and R codes.  They are configured to render the Python code blocks, via the `jupyter` engine.

* The html files are rendered from the quarto markdown files.

* The `.ipynb` files contain just the Python code.

* The `.Rmd` files contain just the R code.
