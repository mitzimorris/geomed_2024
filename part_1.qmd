...
For efficiency, whenever possible, use `transformed data`, `generated quantities` blocks
instead of  `transformed parameters` or `model` blocks.
...
# Notebook One:  Model Building Workflow
