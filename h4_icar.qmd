...
corr_plot = plot_icar_corr_matrix(y_rep_icar, 'ICAR correlation matrix', (10, 10))
corr_plot
```
...
plot_icar_corr_matrix(y_rep_icar, 'ICAR correlation matrix')
```

The long diagnonal edge shows evidence of high correlation between adjacent regions,
in contrast to the lack of any distinctive pattern along the short edges or interior of the plot.
